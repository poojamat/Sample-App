...
public final class Project12 implements Model {
  ...
  private final @ModelField(targetType="Team12") @HasOne(associatedWith = "id", type = Team12.class) Team12 team = null;
  ...
  private final @ModelField(targetType="ID") String project12TeamName;
