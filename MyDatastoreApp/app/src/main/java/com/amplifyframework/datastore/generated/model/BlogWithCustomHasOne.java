...
public final class BlogWithCustomHasOne implements Model {
  ...
  public static final QueryField DESC = field("BlogWithCustomHasOne", "desc");
  ...
  private BlogWithCustomHasOne(String id, String title, String ownerRefId, String desc) {
    this.id = id;
    this.title = title;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), blogWithCustomHasOne.getId()) &&
              ...
              ObjectsCompat.equals(getDesc(), blogWithCustomHasOne.getDesc()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String ownerRefId, String desc) {
      super.id(id);
      super.title(title)
