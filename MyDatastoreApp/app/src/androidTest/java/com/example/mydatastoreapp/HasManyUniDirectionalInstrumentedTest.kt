...
class HasManyUniDirectionalInstrumentedTest {
        ...
        Amplify.Hub.subscribe(HubChannel.DATASTORE,
                { it.name.equals(DataStoreChannelEventName.OUTBOX_MUTATION_PROCESSED.toString()) },
                {
                    ...
                    if (outboxMutationEvent.modelName == "Post21") {
                        ...
                        if ( comment21.id == comment21Processed.id){
                            ...
                            assertEquals(comment21.post21CommentsTitle, comment21Processed.post21CommentsTitle)
